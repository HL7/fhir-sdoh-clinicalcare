...
3. The Provider's System provides (via a FHIR API) the ability to share information with:
   ...
   *  Responsible Payer -- with the patient's consent, provide access to health concerns (Problems) and Interventions to facilitate shared care planning for the covered member.
