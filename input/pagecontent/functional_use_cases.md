...
| ------------------- | ---------------------- | ------- | ---------------- |
| [Direct Referral](functional_use_cases.html#directreferral) | A referral between a referral entity (e.g., Provider) and a performing entity (e.g., CBO) where both entities have FHIR APIs to facilitate exchange and an intermediary (e.g., CP) is not involved in the referral | ![providericon], ![ccicon], ![patienticon], ![cboicon] |   [Direct Referral Exchange Workflow](exchange_workflow#direct-referral-exchange)              |
