...
- §cap-1:Each [SDOHCC Healthcare Service for Referral Management](StructureDefinition-SDOHCC-HealthcareServiceForReferralManagement.html) resource in the response **SHALL** indicate its current capacity status.§
- The capacity status can be one of the following: 'Has Capacity', 'No Capacity', 'No Capacity - Has Waitlist', or 'Additional Assessment Required'.
