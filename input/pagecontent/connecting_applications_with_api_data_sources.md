...
2. On the first use of the application
  ...
  * On this initial authentication, the user will not yet have authorization credentials and will need to create a new 'account'.  The authorization server will verify the user's identity using credentials known to or provided by the care provider (E.g. email address, DOB, registration code, etc.).
