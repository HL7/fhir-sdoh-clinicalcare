...
| [Observation]( http://hl7.org/fhir/Observation.html)         | No                                                           | [Yes](StructureDefinition-SDOHCC-ObservationEthnicity.html) | a patient ethnicity observation                |
| [Observation]( http://hl7.org/fhir/Observation.html)         | No                                                           | [Yes](StructureDefinition-SDOHCC-ObservationRace.html) | a patient race observation                    |
...
| [PractitionerRole]( http://hl7.org/fhir/PractitionerRole.html) | [Yes](http://hl7.org/fhir/us/core/STU4/StructureDefinition-us-core-practitionerrole.html) | No                                                           | provider role                                                |
...
| [SDOHCC ValueSet Observation DataAbsentReason]( ValueSet-SDOHCC-ValueSetObservationDataAbsentReason.html) | specific codes from the [HL7 DataAbsentReason](http://hl7.org/fhir/R4/codesystem-data-absent-reason.html) value set | [ SDOHCC Observation Ethnicity](StructureDefinition-SDOHCC-ObservationEthnicity.html) and [ SDOHCC Observation Race](StructureDefinition-SDOHCC-ObservationRace.html) |
