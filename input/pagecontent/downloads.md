...
The entire implementation guide (including the HTML files, definitions, validation information, etc.) may be downloaded [here](https://build.fhir.org/ig/HL7/fhir-sdoh-clinicalcare/full-ig.zip).
...
* [XML](https://www.hl7.org/fhir/definitions.xml.zip)
* [JSON](https://www.hl7.org/fhir/definitions.json.zip)
* [TTL](https://www.hl7.org/fhir/definitions.ttl.zip)

### Examples: all the examples that are used in this Implementation Guide available for download:

* [XML](https://www.hl7.org/fhir/examples.xml.zip)
* [JSON](https://www.hl7.org/fhir/examples.json.zip)
* [TTl](https://www.hl7.org/fhir/examples.ttl.zip)
