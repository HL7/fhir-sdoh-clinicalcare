...
* [Package]({{site.data.fhir.ver.sdoh-clinicalcare}}/package.tgz)

### Format Specific Definition Files

* [XML]({{site.data.fhir.ver.sdoh-clinicalcare}}/definitions.xml.zip)
* [JSON]({{site.data.fhir.ver.sdoh-clinicalcare}}/definitions.json.zip)
* [TTL]({{site.data.fhir.ver.sdoh-clinicalcare}}/definitions.ttl.zip)

### Examples: all the examples that are used in this Implementation Guide available for download:

* [XML]({{site.data.fhir.ver.sdoh-clinicalcare}}/examples.xml.zip)
* [JSON]({{site.data.fhir.ver.sdoh-clinicalcare}}/examples.json.zip)
* [TTl]({{site.data.fhir.ver.sdoh-clinicalcare}}/examples.ttl.zip)
