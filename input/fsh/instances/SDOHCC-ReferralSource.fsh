Instance: SDOHCC-ReferralSource
InstanceOf: CapabilityStatement
Title: "SDOHCC Referral Source Capability Statement"
...
* format[+] = #json
* rest[0].mode = #client
* rest[=].documentation = "The referral source needs to receive information about procedures done in response to referrals.  They SHOULD also be able to receive information from upstream systems in cases where they are referred to themselves."
...
* rest[=].resource[=].supportedProfile = "http://hl7.org/fhir/us/sdoh-clinicalcare/StructureDefinition/SDOHCC-Procedure"
  * extension.url = "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation"
  * extension.valueCode = #SHALL
* rest[=].resource[=].documentation = "Used to access information from downstream systems about actions that have been performed as a result of a referral"
* rest[=].resource[=].interaction[0].extension.url = "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation"
* rest[=].resource[=].interaction[=].extension.valueCode = #SHALL
* rest[=].resource[=].interaction[=].code = #read
* rest[=].resource[=].interaction[=].documentation = "Allows the referral source to retrieve procedures referenced by Tasks from more sophisticated 'delivery' systems that store their data on their own system rather than using the referral source as a persistence layer."
* rest[=].resource[=].interaction[+].extension.url = "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation"
* rest[=].resource[=].interaction[=].extension.valueCode = #SHOULD
* rest[=].resource[=].interaction[=].code = #search-type
* rest[=].resource[=].interaction[=].documentation = "Allows the referral source to check for updates on Procedures after they've already been received or to look for procedures that haven't yet been linked as outputs to the Tasks that initiated the work."
...
* rest[=].resource[=].supportedProfile = "http://hl7.org/fhir/uv/subscriptions-backport/StructureDefinition/backport-subscription"
  * extension.url = "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation"
  * extension.valueCode = #SHALL
* rest[=].resource[=].documentation = "When tasks have been created on upstream systems, used to access information about updates to those Tasks"
* rest[=].resource[=].interaction[0].extension.url = "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation"
* rest[=].resource[=].interaction[=].extension.valueCode = #SHOULD
...
* rest[=].resource[=].interaction[=].extension.valueCode = #SHALL
* rest[=].resource[=].interaction[=].code = #create
* rest[=].resource[=].interaction[=].documentation = "Allows the referral source to create tasks on a delivery system (or downstream coordination system)."
* rest[=].resource[=].interaction[+].extension.url = "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation"
* rest[=].resource[=].interaction[=].extension.valueCode = #SHALL
* rest[=].resource[=].interaction[=].code = #update
* rest[=].resource[=].interaction[=].documentation = "Allows the referral source to modify the status of previously created tasks - e.g. to cancel them."
* rest[=].resource[=].interaction[+].extension.url = "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation"
* rest[=].resource[=].interaction[=].extension.valueCode = #SHALL
* rest[=].resource[=].interaction[=].code = #read
* rest[=].resource[=].interaction[=].documentation = "Allows the referral source to poll a single Task for changes."
* rest[=].resource[=].interaction[+].extension.url = "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation"
* rest[=].resource[=].interaction[=].extension.valueCode = #SHOULD
* rest[=].resource[=].interaction[=].code = #search-type
* rest[=].resource[=].interaction[=].documentation = "Allows the referral source to poll multiple tasks simultaneously, as well as to retrieve referenced resources as part of a single query."
* rest[=].resource[=].versioning = #versioned-update
...
//* rest[=].resource[=].interaction[=].fhir_comments = "Why do we allow this?"
* rest[=].resource[=].interaction[+].extension.url = "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation"
* rest[=].resource[=].interaction[=].extension.valueCode = #SHOULD
* rest[=].resource[=].interaction[=].code = #search-type
...
* rest[=].resource[=].supportedProfile[+].extension.url = "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation"
* rest[=].resource[=].supportedProfile[=].extension.valueCode = #SHALL
* rest[=].resource[=].documentation = "Used to allow downstream systems to access to information about SDOH-related observations for a patient - particularly those that are reasons for a referral"
* rest[=].resource[=].interaction[0].extension.url = "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation"
* rest[=].resource[=].interaction[=].extension.valueCode = #MAY
* rest[=].resource[=].interaction[=].code = #create
* rest[=].resource[=].interaction[=].documentation = "Allows records to be authored by a SMART app if the manager system does not have the capability itself - or finds it better to use a third-party interface."
...
* rest[=].resource[=].supportedProfile = "http://hl7.org/fhir/uv/subscriptions-backport/StructureDefinition/backport-subscription"
  * extension.url = "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation"
  * extension.valueCode = #SHALL
* rest[=].resource[=].documentation = "Used to allow downstream (and occasionally upstream) systems to subscribe to and monitor changes to Tasks stored on this system"
* rest[=].resource[=].interaction[0].extension.url = "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation"
* rest[=].resource[=].interaction[=].extension.valueCode = #SHOULD
* rest[=].resource[=].interaction[=].code = #create
...
* rest[=].resource[=].interaction[=].extension.valueCode = #SHALL
* rest[=].resource[=].interaction[=].code = #create
* rest[=].resource[=].interaction[=].documentation = "Allows upstream coordination platforms and referral sources system to create tasks on this system seeking fulfillment of a ServiceRequest or an action to be performed by a patient or caregiver."
* rest[=].resource[=].interaction[+].extension.url = "http://hl7.org/fhir/StructureDefinition/capabilitystatement-expectation"
* rest[=].resource[=].interaction[=].extension.valueCode = #SHALL
* rest[=].resource[=].interaction[=].code = #update
