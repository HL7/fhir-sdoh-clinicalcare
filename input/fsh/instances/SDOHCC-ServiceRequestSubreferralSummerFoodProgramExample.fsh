...
Description: "An example of a completed, original-order ServiceRequest (i.e., SDOHCC Service Request Active Food Pantry Application Assist Example) that is based on a Service Request to an intermediary, whose coordination platform (CP) then created this Service Request (i.e., Assistance with application for Summer Food Service Program) to be fulfilled by a Community Based Organization."
Usage: #example
