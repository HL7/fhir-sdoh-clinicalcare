Instance: SDOHCC-TaskReferralForFurtherAssessmentMSW
InstanceOf: SDOHCCTaskForReferralManagement
Title: "SDOHCC Task For Referral For Further Assessment By Social Worker Example"
Description: "An example of a Task resource representing a referral for further assessment from a social worker."
Usage: #example
* intent = #order
...
* requester.reference = "PractitionerRole/SDOHCC-PractitionerRolePatWilliamsMSWExample"
* requester.display = "Pat Williams, MSW - Social Worker"
