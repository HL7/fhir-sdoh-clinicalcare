Profile: SDOHCCServiceRequest_health_insurance_coverage_status
...
* code ^binding.extension[=].extension[=].valueCanonical = http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113762.1.4.1247.124
