...
* outcomeReference[SupportedOutcomeReference] ^requirements = "When a goal outcome can be represented by SDOH screening response observations or SDOH assessment observations, Goal.outcome should reference instances that comply with the SDOHCC Screening Response Observation or SDOHCC Assessment Observation profiles. However, references to other instance types are also possible."