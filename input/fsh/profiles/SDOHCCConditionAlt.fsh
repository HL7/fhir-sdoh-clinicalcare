...
* code.coding[educational-attainment] from $2.16.840.1.113762.1.4.1247.103 (required)
* code.coding[educational-attainment] ^short = "Educational Attainment"
* code.coding[elder-abuse] from $2.16.840.1.113762.1.4.1247.63 (required)
* code.coding[elder-abuse] ^short = "Elder Abuse"
* code.coding[unemployment] from $2.16.840.1.113762.1.4.1247.62 (required)
* code.coding[unemployment] ^short = "Unemployment"
* code.coding[financial-insecurity] from $2.16.840.1.113762.1.4.1247.108 (required)
* code.coding[financial-insecurity] ^short = "Financial Insecurity"
* code.coding[food-insecurity] from $2.16.840.1.113762.1.4.1247.17 (required)
* code.coding[food-insecurity] ^short = "Food Insecurity"
* code.coding[health-insurance-coverage] from $2.16.840.1.113762.1.4.1247.148 (required)
