...
//* category[problem-or-health-concern] ^condition = "SDOH-Con-2"
* category[problem-or-health-concern] from USCoreProblemOrHealthConcern|7.0.0 (required)
...
* category[screening-assessment] from USCoreScreeningAssessmentConditionCategory|7.0.0 (required)
...
* insert AdditionalBinding(SDOHCCCondition, code, Condition.category, protective-factor, http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113762.1.4.1247.311, extensible)
* insert AdditionalBinding(SDOHCCCondition, code, Condition.category, sdoh-category-unspecified, http://hl7.org/fhir/us/core/ValueSet/us-core-condition-code|7.0.0, required)
...
* asserter only Reference(RelatedPerson or USCorePatientProfile|7.0.0 or USCorePractitionerProfile|7.0.0 or SDOHCCPractitionerRole)
* asserter MS
