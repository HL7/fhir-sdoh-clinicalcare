...
* category ^slicing.discriminator.type = #value
  ...
  * ^slicing.rules = #open
  * ^requirements = "To identify that an SDOH screening response observation is derived from an SDOH questionnaire, the “social-history” and “survey” codes are required."
* category contains
    SocialHistory 1..1 MS and
    Survey 1..1 MS and
    SDOH 0..* MS
* category[SocialHistory] = $observation-category#social-history
  * ^requirements = "Used for filtering social history observations."
* category[Survey] = $observation-category#survey
  * ^requirements = "Used for filtering observations derived from a survey/questionnaire."
...
* valueQuantity from $v3-UnitsOfMeasureCaseSensitive (required)
  ...
  * ^binding.description = "This is the entire UCUM code set."
...
* valueCodeableConcept from LOINCCodes (preferred)
  ...
  * ^binding.description = "This value set includes all LOINC codes"
* dataAbsentReason MS
...
* derivedFrom[SupportedDerivedFrom] only Reference(SDOHCCObservationScreeningResponse or SDCQuestionnaireResponse)
  ...
  * ^definition = "Questionnaire responses or observations from which this observation value is derived."
